...
export default function Home() {
  ...
  return (
    <div className="w-full h-screen relative flex flex-col items-center justify-between">
      ...
      <div className="w-[1594px] h-[2543px] border-[10px] border-black z-20 rounded-[50px] flex flex-col items-center justify-between ">
        <div
        ...
        <div className="w-[1368px] h-[2070px] border-[10px] border-black z-20 rounded-[50px] mb-[100px] relative overflow-hidden flex flex-col items-center justify-end">
          <div className="qrcode absolute bottom-0 right-0 w-[460px] h-[460px] bg-white z-30 border-l-[10px] border-t-[10px] border-black rounded-tl-[50px] flex items-center justify-center">
            <QRCodeComponent 
          ...
          />
          <div className="w-full h-[290px] z-20 bg-[#E4BE50] flex flex-row border relative">
            {/* 네임택 위 텍스트 */}
            <div 
      ...
      <div className="flex items-center justify-center z-30 flex-row mb-[358px] gap-x-24 ">
        <Button
