...
export default function Home() {
  ...
  return (
    <div className="w-full h-screen relative flex flex-col items-center justify-between">
      ...
      <div className="flex flex-col items-center justify-center z-30 border-[25px] border-[#D3B582] rounded-[60px] w-[1666px] h-[390px]">
      ...
      <div className="flex items-center justify-center z-30 flex-row mb-[358px] mt-[191px]">
        <div 
